...
define('durandal/binder',["durandal/system","knockout"],function(e,t){function n(t){return void 0===t?{applyBindings:!0}:e.isBoolean(t)?{applyBindings:t}:(void 0===t.applyBindings&&(t.applyBindings=!0),t)}function i(i,s,l,d){if(!s||!l)return r.throwOnErrors?e.error(a):e.log(a,s,d),void 0;if(!s.getAttribute)return r.throwOnErrors?e.error(o):e.log(o,s,d),void 0;var f=s.getAttribute("data-view");try{var v;return i&&i.binding&&(v=i.binding(s)),v=n(v),r.binding(d,s,v),v.applyBindings?(e.log("Binding",f,d),t.applyBindings(l,s)):i&&t.utils.domData.set(s,u,{$data:i}),r.bindingComplete(d,s,v),i&&i.bindingComplete&&i.bindingComplete(s),t.utils.domData.set(s,c,v),v}catch(g){g.message=g.message+";\nView: "+f+";\nModuleId: "+e.getModuleId(d),r.throwOnErrors?e.error(g):e.log(g.message)}}var r,a="Insufficient Information to Bind",o="Unexpected View Type",c="durandal-binding-instruction",u="__ko_bindingContext__";return r={binding:e.noop,bindingComplete:e.noop,throwOnErrors:!1,getBindingInstruction:function(e){return t.utils.domData.get(e,c)},bindContext:function(e,t,n){return n&&e&&(e=e.createChildContext(n)),i(n,t,e,n||(e?e.$data:null))},bind:function(e,t){return i(e,t,e,e)}}});
define('durandal/activator',["durandal/system","knockout"],function(e,t){function n(e){return void 0==e&&(e={}),e.closeOnDeactivate||(e.closeOnDeactivate=s.defaults.closeOnDeactivate),e.beforeActivate||(e.beforeActivate=s.defaults.beforeActivate),e.afterDeactivate||(e.afterDeactivate=s.defaults.afterDeactivate),e.affirmations||(e.affirmations=s.defaults.affirmations),e.interpretResponse||(e.interpretResponse=s.defaults.interpretResponse),e.areSameItem||(e.areSameItem=s.defaults.areSameItem),e}function r(t,n,r){return e.isArray(r)?t[n].apply(t,r):t[n](r)}function i(t,n,r,i,a){if(t&&t.deactivate){e.log("Deactivating",t);var o;try{o=t.deactivate(n)}catch(c){return e.error(c),i.resolve(!1),void 0}o&&o.then?o.then(function(){r.afterDeactivate(t,n,a),i.resolve(!0)},function(t){e.log(t),i.resolve(!1)}):(r.afterDeactivate(t,n,a),i.resolve(!0))}else t&&r.afterDeactivate(t,n,a),i.resolve(!0)}function a(t,n,i,a){if(t)if(t.activate){e.log("Activating",t);var o;try{o=r(t,"activate",a)}catch(c){return e.error(c),i(!1),void 0}o&&o.then?o.then(function(){n(t),i(!0)},function(t){e.log(t),i(!1)}):(n(t),i(!0))}else n(t),i(!0);else i(!0)}function o(t,n,r){return r.lifecycleData=null,e.defer(function(i){if(t&&t.canDeactivate){var a;try{a=t.canDeactivate(n)}catch(o){return e.error(o),i.resolve(!1),void 0}a.then?a.then(function(e){r.lifecycleData=e,i.resolve(r.interpretResponse(e))},function(t){e.error(t),i.resolve(!1)}):(r.lifecycleData=a,i.resolve(r.interpretResponse(a)))}else i.resolve(!0)}).promise()}function c(t,n,i,a){return i.lifecycleData=null,e.defer(function(o){if(t==n())return o.resolve(!0),void 0;if(t&&t.canActivate){var c;try{c=r(t,"canActivate",a)}catch(u){return e.error(u),o.resolve(!1),void 0}c.then?c.then(function(e){i.lifecycleData=e,o.resolve(i.interpretResponse(e))},function(t){e.error(t),o.resolve(!1)}):(i.lifecycleData=c,o.resolve(i.interpretResponse(c)))}else o.resolve(!0)}).promise()}function u(r,u){var s,l=t.observable(null);u=n(u);var f=t.computed({read:function(){return l()},write:function(e){f.viaSetter=!0,f.activateItem(e)}});return f.__activator__=!0,f.settings=u,u.activator=f,f.isActivating=t.observable(!1),f.canDeactivateItem=function(e,t){return o(e,t,u)},f.deactivateItem=function(t,n){return e.defer(function(e){f.canDeactivateItem(t,n).then(function(r){r?i(t,n,u,e,l):(f.notifySubscribers(),e.resolve(!1))})}).promise()},f.canActivateItem=function(e,t){return c(e,l,u,t)},f.activateItem=function(t,n){var r=f.viaSetter;return f.viaSetter=!1,e.defer(function(o){if(f.isActivating())return o.resolve(!1),void 0;f.isActivating(!0);var c=l();return u.areSameItem(c,t,s,n)?(f.isActivating(!1),o.resolve(!0),void 0):(f.canDeactivateItem(c,u.closeOnDeactivate).then(function(v){v?f.canActivateItem(t,n).then(function(v){v?e.defer(function(e){i(c,u.closeOnDeactivate,u,e)}).promise().then(function(){t=u.beforeActivate(t,n),a(t,l,function(e){s=n,f.isActivating(!1),o.resolve(e)},n)}):(r&&f.notifySubscribers(),f.isActivating(!1),o.resolve(!1))}):(r&&f.notifySubscribers(),f.isActivating(!1),o.resolve(!1))}),void 0)}).promise()},f.canActivate=function(){var e;return r?(e=r,r=!1):e=f(),f.canActivateItem(e)},f.activate=function(){var e;return r?(e=r,r=!1):e=f(),f.activateItem(e)},f.canDeactivate=function(e){return f.canDeactivateItem(f(),e)},f.deactivate=function(e){return f.deactivateItem(f(),e)},f.includeIn=function(e){e.canActivate=function(){return f.canActivate()},e.activate=function(){return f.activate()},e.canDeactivate=function(e){return f.canDeactivate(e)},e.deactivate=function(e){return f.deactivate(e)}},u.includeIn?f.includeIn(u.includeIn):r&&f.activate(),f.forItems=function(t){u.closeOnDeactivate=!1,u.determineNextItemToActivate=function(e,t){var n=t-1;return-1==n&&e.length>1?e[1]:n>-1&&n<e.length-1?e[n]:null},u.beforeActivate=function(e){var n=f();if(e){var r=t.indexOf(e);-1==r?t.push(e):e=t()[r]}else e=u.determineNextItemToActivate(t,n?t.indexOf(n):0);return e},u.afterDeactivate=function(e,n){n&&t.remove(e)};var n=f.canDeactivate;f.canDeactivate=function(r){return r?e.defer(function(e){function n(){for(var t=0;t<a.length;t++)if(!a[t])return e.resolve(!1),void 0;e.resolve(!0)}for(var i=t(),a=[],o=0;o<i.length;o++)f.canDeactivateItem(i[o],r).then(function(e){a.push(e),a.length==i.length&&n()})}).promise():n()};var r=f.deactivate;return f.deactivate=function(n){return n?e.defer(function(e){function r(r){f.deactivateItem(r,n).then(function(){a++,t.remove(r),a==o&&e.resolve()})}for(var i=t(),a=0,o=i.length,c=0;o>c;c++)r(i[c])}).promise():r()},f},f}var s,l={closeOnDeactivate:!0,affirmations:["yes","ok","true"],interpretResponse:function(n){return e.isObject(n)&&(n=n.can||!1),e.isString(n)?-1!==t.utils.arrayIndexOf(this.affirmations,n.toLowerCase()):n},areSameItem:function(e,t){return e==t},beforeActivate:function(e){return e},afterDeactivate:function(e,t,n){t&&n&&n(null)}};return s={defaults:l,create:u,isActivator:function(e){return e&&e.__activator__}}});
...
define('durandal/app',["durandal/system","durandal/viewEngine","durandal/composition","durandal/events","jquery"],function(e,t,n,r,i){function a(){return e.defer(function(t){return 0==c.length?(t.resolve(),void 0):(e.acquire(c).then(function(n){for(var r=0;r<n.length;r++){var i=n[r];if(i.install){var a=u[r];e.isObject(a)||(a={}),i.install(a),e.log("Plugin:Installed "+c[r])}else e.log("Plugin:Loaded "+c[r])}t.resolve()}).fail(function(t){e.error("Failed to load plugin(s). Details: "+t.message)}),void 0)}).promise()}var o,c=[],u=[];return o={title:"Application",configurePlugins:function(t,n){var r=e.keys(t);n=n||"plugins/",-1===n.indexOf("/",n.length-1)&&(n+="/");for(var i=0;i<r.length;i++){var a=r[i];c.push(n+a),u.push(t[a])}},start:function(){return e.log("Application:Starting"),this.title&&(document.title=this.title),e.defer(function(t){i(function(){a().then(function(){t.resolve(),e.log("Application:Started")})})}).promise()},setRoot:function(r,i,a){var o,c={activate:!0,transition:i};o=!a||e.isString(a)?document.getElementById(a||"applicationHost"):a,e.isString(r)?t.isViewUrl(r)?c.view=r:c.model=r:c.model=r,n.compose(o,c)}},r.includeIn(o),o});
...
define('plugins/router',["durandal/system","durandal/app","durandal/activator","durandal/events","durandal/composition","plugins/history","knockout","jquery"],function(e,t,n,i,r,a,o,c){function s(e){return e=e.replace(b,"\\$&").replace(p,"(?:$1)?").replace(h,function(e,t){return t?e:"([^/]+)"}).replace(m,"(.*?)"),new RegExp("^"+e+"$")}function u(e){var t=e.indexOf(":"),n=t>0?t-1:e.length;return e.substring(0,n)}function l(e){return e.router&&e.router.loadUrl}function d(e,t){return-1!==e.indexOf(t,e.length-t.length)}function f(e,t){if(!e||!t)return!1;if(e.length!=t.length)return!1;for(var n=0,i=e.length;i>n;n++)if(e[n]!=t[n])return!1;return!0}var v,g,p=/\((.*?)\)/g,h=/(\(\?)?:\w+/g,m=/\*\w+/g,b=/[\-{}\[\]+?.,\\\^$|#\s]/g,y=/\/$/,w=function(){function r(t,n){e.log("Navigation Complete",t,n);var i=e.getModuleId(C);i&&P.trigger("router:navigation:from:"+i),C=t,O=n;var r=e.getModuleId(C);r&&P.trigger("router:navigation:to:"+r),l(t)||P.updateDocumentTitle(t,n),g.explicitNavigation=!1,g.navigatingBack=!1,P.trigger("router:navigation:complete",t,n,P)}function c(t,n){e.log("Navigation Cancelled"),P.activeInstruction(O),O&&P.navigate(O.fragment,!1),N(!1),g.explicitNavigation=!1,g.navigatingBack=!1,P.trigger("router:navigation:cancelled",t,n,P)}function p(t){e.log("Navigation Redirecting"),N(!1),g.explicitNavigation=!1,g.navigatingBack=!1,P.navigate(t,{trigger:!0,replace:!0})}function h(e,t,n){g.navigatingBack=!g.explicitNavigation&&C!=n.fragment,P.trigger("router:route:activating",t,n,P),e.activateItem(t,n.params).then(function(i){if(i){var a=C;r(t,n),l(t)&&I({router:t.router,fragment:n.fragment,queryString:n.queryString}),a==t&&P.attached()}else e.settings.lifecycleData&&e.settings.lifecycleData.redirect?p(e.settings.lifecycleData.redirect):c(t,n);v&&(v.resolve(),v=null)})}function m(t,n,i){var r=P.guardRoute(n,i);r?r.then?r.then(function(r){r?e.isString(r)?p(r):h(t,n,i):c(n,i)}):e.isString(r)?p(r):h(t,n,i):c(n,i)}function b(e,t,n){P.guardRoute?m(e,t,n):h(e,t,n)}function _(e){return O&&O.config.moduleId==e.config.moduleId&&C&&(C.canReuseForRoute&&C.canReuseForRoute.apply(C,e.params)||C.router&&C.router.loadUrl)}function x(){if(!N()){var t=V.shift();if(V=[],t){if(t.router){var i=t.fragment;return t.queryString&&(i+="?"+t.queryString),t.router.loadUrl(i),void 0}N(!0),P.activeInstruction(t),_(t)?b(n.create(),C,t):e.acquire(t.config.moduleId).then(function(n){var i=e.resolveObject(n);b(T,i,t)}).fail(function(n){e.error("Failed to load routed module ("+t.config.moduleId+"). Details: "+n.message)})}}}function I(e){V.unshift(e),x()}function S(e,t,n){for(var i=e.exec(t).slice(1),r=0;r<i.length;r++){var a=i[r];i[r]=a?decodeURIComponent(a):null}var o=P.parseQueryString(n);return o&&i.push(o),{params:i,queryParams:o}}function k(t){P.trigger("router:route:before-config",t,P),e.isRegExp(t)?t.routePattern=t.route:(t.title=t.title||P.convertRouteToTitle(t.route),t.moduleId=t.moduleId||P.convertRouteToModuleId(t.route),t.hash=t.hash||P.convertRouteToHash(t.route),t.routePattern=s(t.route)),P.trigger("router:route:after-config",t,P),P.routes.push(t),P.route(t.routePattern,function(e,n){var i=S(t.routePattern,e,n);I({fragment:e,queryString:n,config:t,params:i.params,queryParams:i.queryParams})})}function A(t){if(e.isArray(t.route))for(var n=0,i=t.route.length;i>n;n++){var r=e.extend({},t);r.route=t.route[n],n>0&&delete r.nav,k(r)}else k(t);return P}function D(e){e.isActive||(e.isActive=o.computed(function(){var t=T();return t&&t.__moduleId__==e.moduleId}))}var C,O,V=[],N=o.observable(!1),T=n.create(),P={handlers:[],routes:[],navigationModel:o.observableArray([]),activeItem:T,isNavigating:o.computed(function(){var e=T(),t=N(),n=e&&e.router&&e.router!=P&&e.router.isNavigating()?!0:!1;return t||n}),activeInstruction:o.observable(null),__router__:!0};return i.includeIn(P),T.settings.areSameItem=function(e,t,n,i){return e==t?f(n,i):!1},P.parseQueryString=function(e){var t,n;if(!e)return null;if(n=e.split("&"),0==n.length)return null;t={};for(var i=0;i<n.length;i++){var r=n[i];if(""!==r){var a=r.split("=");t[a[0]]=a[1]&&decodeURIComponent(a[1].replace(/\+/g," "))}}return t},P.route=function(e,t){P.handlers.push({routePattern:e,callback:t})},P.loadUrl=function(t){var n=P.handlers,i=null,r=t,o=t.indexOf("?");if(-1!=o&&(r=t.substring(0,o),i=t.substr(o+1)),P.relativeToParentRouter){var c=this.parent.activeInstruction();r=c.params.join("/"),r&&"/"==r[0]&&(r=r.substr(1)),r||(r=""),r=r.replace("//","/").replace("//","/")}r=r.replace(y,"");for(var s=0;s<n.length;s++){var u=n[s];if(u.routePattern.test(r))return u.callback(r,i),!0}return e.log("Route Not Found"),P.trigger("router:route:not-found",t,P),O&&a.navigate(O.fragment,{trigger:!1,replace:!0}),g.explicitNavigation=!1,g.navigatingBack=!1,!1},P.updateDocumentTitle=function(e,n){n.config.title?document.title=t.title?n.config.title+" | "+t.title:n.config.title:t.title&&(document.title=t.title)},P.navigate=function(e,t){return e&&-1!=e.indexOf("://")?(window.location.href=e,!0):(g.explicitNavigation=!0,a.navigate(e,t))},P.navigateBack=function(){a.navigateBack()},P.attached=function(){setTimeout(function(){N(!1),P.trigger("router:navigation:attached",C,O,P),x()},10)},P.compositionComplete=function(){P.trigger("router:navigation:composition-complete",C,O,P)},P.convertRouteToHash=function(e){if(P.relativeToParentRouter){var t=P.parent.activeInstruction(),n=t.config.hash+"/"+e;return a._hasPushState&&(n="/"+n),n=n.replace("//","/").replace("//","/")}return a._hasPushState?e:"#"+e},P.convertRouteToModuleId=function(e){return u(e)},P.convertRouteToTitle=function(e){var t=u(e);return t.substring(0,1).toUpperCase()+t.substring(1)},P.map=function(t,n){if(e.isArray(t)){for(var i=0;i<t.length;i++)P.map(t[i]);return P}return e.isString(t)||e.isRegExp(t)?(n?e.isString(n)&&(n={moduleId:n}):n={},n.route=t):n=t,A(n)},P.buildNavigationModel=function(t){var n=[],i=P.routes;t=t||100;for(var r=0;r<i.length;r++){var a=i[r];a.nav&&(e.isNumber(a.nav)||(a.nav=t),D(a),n.push(a))}return n.sort(function(e,t){return e.nav-t.nav}),P.navigationModel(n),P},P.mapUnknownRoutes=function(t,n){var i="*catchall",r=s(i);return P.route(r,function(o,c){var s=S(r,o,c),u={fragment:o,queryString:c,config:{route:i,routePattern:r},params:s.params,queryParams:s.queryParams};if(t)if(e.isString(t))u.config.moduleId=t,n&&a.navigate(n,{trigger:!1,replace:!0});else if(e.isFunction(t)){var l=t(u);if(l&&l.then)return l.then(function(){P.trigger("router:route:before-config",u.config,P),P.trigger("router:route:after-config",u.config,P),I(u)}),void 0}else u.config=t,u.config.route=i,u.config.routePattern=r;else u.config.moduleId=o;P.trigger("router:route:before-config",u.config,P),P.trigger("router:route:after-config",u.config,P),I(u)}),P},P.reset=function(){return O=C=void 0,P.handlers=[],P.routes=[],P.off(),delete P.options,P},P.makeRelative=function(t){return e.isString(t)&&(t={moduleId:t,route:t}),t.moduleId&&!d(t.moduleId,"/")&&(t.moduleId+="/"),t.route&&!d(t.route,"/")&&(t.route+="/"),t.fromParent&&(P.relativeToParentRouter=!0),P.on("router:route:before-config").then(function(e){t.moduleId&&(e.moduleId=t.moduleId+e.moduleId),t.route&&(e.route=""===e.route?t.route.substring(0,t.route.length-1):t.route+e.route)}),P},P.createChildRouter=function(){var e=w();return e.parent=P,e},P};return g=w(),g.explicitNavigation=!1,g.navigatingBack=!1,g.activate=function(t){return e.defer(function(n){if(v=n,g.options=e.extend({routeHandler:g.loadUrl},g.options,t),a.activate(g.options),a._hasPushState)for(var i=g.routes,r=i.length;r--;){var o=i[r];o.hash=o.hash.replace("#","")}c(document).delegate("a","click",function(e){if(g.explicitNavigation=!0,a._hasPushState&&!(e.altKey||e.ctrlKey||e.metaKey||e.shiftKey)){var t=c(this).attr("href"),n=this.protocol+"//";(!t||"#"!==t.charAt(0)&&t.slice(n.length)!==n)&&(e.preventDefault(),a.navigate(t))}})}).promise()},g.deactivate=function(){a.deactivate()},g.install=function(){o.bindingHandlers.router={init:function(){return{controlsDescendantBindings:!0}},update:function(e,t,n,i,a){var c=o.utils.unwrapObservable(t())||{};if(c.__router__)c={model:c.activeItem(),attached:c.attached,compositionComplete:c.compositionComplete,activate:!1};else{var s=o.utils.unwrapObservable(c.router||i.router)||g;c.model=s.activeItem(),c.attached=s.attached,c.compositionComplete=s.compositionComplete,c.activate=!1}r.compose(e,c,a)}},o.virtualElements.allowedBindings.router=!0},g});
...
define('viewmodels/details',["services/logger"],function(t){function n(){return t.log(r+" View Activated",null,r,!0),!0}var r="Details",e={activate:n,title:r};return e});
define('viewmodels/home',["services/logger"],function(t){function n(){return t.log(e+" View Activated",null,e,!0),!0}var e="Home",r={activate:n,title:e};return r});
define('viewmodels/northwind',['require'],function(e){var t=(e("durandal/app"),e("services/logger"),e("services/datacontext")),r={};return r.orders=ko.observableArray([]),r.isLoading=ko.observable(!1),r.isAttachedToView=ko.observable(!1),r.activate=function(){return r.isLoading(!0),amplify.store("NorthwindOrders")?(r.successCallback(amplify.store("NorthwindOrders")),toastr.info("Retrieved data from LocalStorage Cache")):($.when(t.getOrders()).done(r.successCallback).fail(r.failCallback),toastr.info("Cache expired : Retrieved data from server")),!0},r.successCallback=function(e){void 0===amplify.store("NorthwindOrders")&&amplify.store("NorthwindOrders",e,{expires:6e4}),r.orders=e,r.isLoading(!1),r.isAttachedToView(!0)},r.failCallback=function(e){console.log("Error: "+e.responseText)},r.canDeactivate=function(){return!0},r});
define('viewmodels/shell',["durandal/system","plugins/router","services/logger"],function(e,t,r){function o(){return n()}function n(){i("Hot Towel SPA Loaded!",null,!0),t.on("router:route:not-found",function(e){a("No Route Found",e,!0)});var e=[{route:"",moduleId:"home",title:"Home",nav:1},{route:"details",moduleId:"details",title:"Details",nav:2},{route:"northwind",moduleId:"northwind",title:"Northwind",nav:3}];return t.makeRelative({moduleId:"viewmodels"}).map(e).buildNavigationModel().activate()}function i(t,o,n){r.log(t,o,e.getModuleId(s),n)}function a(t,o,n){r.logError(t,o,e.getModuleId(s),n)}var s={activate:o,router:t};return s});
